    <h1 class="text-primary"><i class="fas fa-users"></i> All Students <small>All Students</small></h1>
                <ol class="breadcrumb">
                  <li><a href="index.php?page=dashboard"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
                  <li class="active"><i class="fas fa-user-plus"></i>All Students</li>
                </ol>
               ...
               <tbody>
                ...
                while ($row = mysqli_fetch_assoc($db_sinfo)){?>
                 ...
                 <tr>
                   ...
                   <td>
                     <a href="index.php?page=update-student&id=<?php echo base64_encode( $row['id']);?>" class="btn btn-xs btn-warning"><i class="fas fa-pencil"></i>Edit</a>
                     &nbsp;&nbsp;
